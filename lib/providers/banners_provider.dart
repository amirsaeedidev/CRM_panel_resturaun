...
class DiscountsProvider extends ChangeNotifier {
  ...
  Future<void> fetchDiscounts() async {
    ...
    try {
      ...
      LoggerService.error('Fetch discounts failed in provider', error: e, stackTrace: st);
      _error = e.toString();
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  Future<bool> createDiscount(Map<String, dynamic> data) async {
    ...
    try {
      ...
      LoggerService.error('Create discount failed in provider', error: e, stackTrace: st);
      _error = e.toString();
      return false;
    } finally {
      _isSaving = false;
  ...
  Future<bool> updateDiscount(String id, Map<String, dynamic> data) async {
    ...
    try {
      ...
      LoggerService.error('Update discount failed in provider', error: e, stackTrace: st);
      _error = e.toString();
      return false;
    } finally {
      _isSaving = false;
  ...
  Future<bool> deleteDiscount(String id) async {
    try {
      ...
      LoggerService.error('Delete discount failed in provider', error: e, stackTrace: st);
      _error = e.toString();
      return false;
    }
  }
